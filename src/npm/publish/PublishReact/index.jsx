  ...
  return (
    <div>
      ...
      <ul>
        <li>
          <a
            href="https://medium.com/dailyjs/building-a-react-component-with-webpack-publish-to-npm-deploy-to-github-guide-6927f60b3220"
            target="_blank"
            rel="noopener noreferrer"
          >
            A guide to building a React component with webpack 4, publishing to
            npm, and deploying the demo to GitHub Pages
          </a>
        </li>
        <li>
          <a
            href="https://blog.logrocket.com/the-complete-guide-to-publishing-a-react-package-to-npm/"
            target="_blank"
            rel="noopener noreferrer"
          >
