...
function Homebrew(props) {
  ...
  return (
    <div>
      ...
      <Paragraph>
        <Text code>homebrew-cask</Text>
        提供已经编译好的应用包(.dmg/.pkg),省却了下载、解压、拖拽等步骤,卸载也相对容易,包含很多AppStore没有的软件
      </Paragraph>
      <StepList
      ...
      <Paragraph>
        <ul>
          <li>
            <a href="http://mirrors.ustc.edu.cn/help/brew.git.html">
              中科大镜像
            </a>
          </li>
          <li>
          ...
          <li>
            <a href="https://developer.aliyun.com/mirror/homebrew?spm=a2c6h.13651102.0.0.3e221b11uLaG0Q">
              阿里巴巴镜像
            </a>
          </li>
        </ul>
