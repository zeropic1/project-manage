  ...
  const data = [
    {
      ...
      install: '自带',
      description:
        "git命令的alias,查看所有的git命令alias:'~/.oh-my-zsh/plugins/git/git.plugin.zsh'"
    },
    {
      key: '2',
      plugin: 'z',
    ...
    },
    {
      ...
      install: '自带',
      description:
        "提供一条 gi 命令,用来查询 gitignore 模板,比如你新建了一个 python 项目,就可以用'gi python > .gitignore'"
    },
    {
      key: '7',
      plugin: 'git-open',
      ...
      description:
        '在终端里打开当前项目的远程仓库地址,github地址(https://github.com/paulirish/git-open)'
    }
  ]
